<?php 
 /**************************************************************/
                add_action('init', 'st_portfolio_register');
                 
                function st_portfolio_register() {
            ...
            /**************************************************************/
            add_action('init', 'st_team_register');
             
            function st_team_register() {
				...
				add_action("admin_init", "st_team_admin_init");
				add_action('save_post', 'st_save_team_details');
				
				function st_team_admin_init(){
	                add_meta_box("team-meta", "Team Options", "st_team_meta", "team", "normal", "low");
				}
				
				function st_team_meta(){
        ...
        /**************************************************************/
        add_action('init', 'st_skills_register');
         
        function st_skills_register() {
        ...
        add_action("admin_init", "st_skills_admin_init");
        add_action('save_post', 'st_save_skills_details');
         
        function st_skills_admin_init(){
         
          add_meta_box("skills-meta", "Skills Options", "st_skills_meta", "skills", "normal", "low");
        }
         
        function st_skills_meta() {
          global $post;
          $custom = get_post_custom($post->ID);
          $digit_number = '';
        ...
        function st_save_skills_details(){
          global $post;
